...
module WhatsAppCloudApi
  ...
  class GetPhoneNumberByIDResponse < BaseModel
    ...
    def self.from_hash(hash)
      ...
      verified_name = hash.key?('verified_name') ? hash['verified_name'] : nil
      display_phone_number =
        hash.key?('display_phone_number') ? hash['display_phone_number'] : nil
      id = hash.key?('id') ? hash['id'] : nil
      quality_rating =
        hash.key?('quality_rating') ? hash['quality_rating'] : nil
